...
## Last Updated
$TODAY. Vault initialized with demo content.

## Key Recent Facts
- This vault was just seeded with starter pages
- See [[wiki/index]] for a map of all page types
- See [[FIRST_RUN]] for setup instructions

## Recent Changes
- Created: [[example-concept]], [[example-entity]], [[example-source]], [[example-question]]

## Active Threads
- New vault — no active research threads yet
EOF
