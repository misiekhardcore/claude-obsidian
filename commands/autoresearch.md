...
First, read `Skill("research-program")` for research constraints. Skill dispatches sub-agents to parallelize search/fetch/synthesis. After agents finish, update wiki index/log/hot.md. Report pages created, key findings, trail page path.
